...
namespace UserModule_SERIAL_DIGITAL_DECOMPRESSOR
{
    public class UserModuleClass_SERIAL_DIGITAL_DECOMPRESSOR : SplusObject
    {
        ...
        object SERIAL_OnChange_0 ( Object __EventInfo__ )
            ...
            try
            {
                ...
                for ( I  = __FN_FORSTART_VAL__1; (__FN_FORSTEP_VAL__1 > 0)  ? ( (I  >= __FN_FORSTART_VAL__1) && (I  <= __FN_FOREND_VAL__1) ) : ( (I  <= __FN_FORSTART_VAL__1) && (I  >= __FN_FOREND_VAL__1) ) ; I  += (ushort)__FN_FORSTEP_VAL__1) 
                    ...
                    if ( Functions.TestForTrue  ( ( Functions.BoolToInt (ANALOG[ I ] == 0))  ) ) 
                        { 
    ...
    public UserModuleClass_SERIAL_DIGITAL_DECOMPRESSOR ( string InstanceName, string ReferenceID, Crestron.Logos.SplusObjects.CrestronStringEncoding nEncodingType ) : base( InstanceName, ReferenceID, nEncodingType ) {}
