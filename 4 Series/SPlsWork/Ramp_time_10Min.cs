...
namespace UserModule_RAMP_TIME_10MIN
{
    public class UserModuleClass_RAMP_TIME_10MIN : SplusObject
    {
    ...
    public UserModuleClass_RAMP_TIME_10MIN ( string InstanceName, string ReferenceID, Crestron.Logos.SplusObjects.CrestronStringEncoding nEncodingType ) : base( InstanceName, ReferenceID, nEncodingType ) {}
