...
namespace UserModule_DIGITAL_SERIAL_COMPRESSOR
{
    public class UserModuleClass_DIGITAL_SERIAL_COMPRESSOR : SplusObject
    {
        ...
        object CONVERT_OnPush_0 ( Object __EventInfo__ )
            ...
            try
            {
                ...
                TEMP  = new CrestronString( Crestron.Logos.SplusObjects.CrestronStringEncoding.eEncodingASCII, 1000, this );
    ...
    public UserModuleClass_DIGITAL_SERIAL_COMPRESSOR ( string InstanceName, string ReferenceID, Crestron.Logos.SplusObjects.CrestronStringEncoding nEncodingType ) : base( InstanceName, ReferenceID, nEncodingType ) {}
